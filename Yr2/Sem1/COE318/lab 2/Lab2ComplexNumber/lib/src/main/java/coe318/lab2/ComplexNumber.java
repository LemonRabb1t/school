...
//Initialize the instance variables
    ...
    public double getImaginary() {
        return imaginepart;	//A stub: to be fixed
    }
    ...
    public ComplexNumber add(ComplexNumber z) {
        return new ComplexNumber (getReal() + z.getReal(), getImaginary() + z.getImaginary());	//A stub: to be fixed
    }
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        return new ComplexNumber (getReal()*z.getReal() - getImaginary()*z.getImaginary() , getReal() * z.getImaginary() + getImaginary() * z.getReal());	//A stub: to be fixed
    }
    ...
    public ComplexNumber reciprocal() {
        return new ComplexNumber (getReal()/(getReal()*getReal()+getImaginary()*getImaginary()), getImaginary()*-1/(getReal()*getReal()+getImaginary()*getImaginary()));
    }
    ...
    public ComplexNumber divide(ComplexNumber z) {
        return new ComplexNumber ((getReal()*z.getReal() + getImaginary()*z.getImaginary()) / (z.getReal()*z.getReal()+z.getImaginary()*z.getImaginary()) ,(getImaginary() * z.getReal() - getReal() * z.getImaginary())/(z.getReal()*z.getReal()+z.getImaginary()*z.getImaginary()));//A stub: to be fixed
    }
